...
import com.freddieapp.loanorigination.client.notification.NotificationClient;
...
import com.freddieapp.loanorigination.processor.LoanApplicationProcessor;
...
public class LoanOriginationService {
    ...
    private final LoanApplicationProcessor loanProcessor;
    ...
    public Page<LoanApplicationResponse> getLoansByCustomer(String customerId, Pageable pageable) {
        return loanRepository.findByCustomerIdNative(customerId, pageable)
                .map(this::toResponse);
    }
    ...
    public LoanApplicationResponse submitForUnderwriting(String loanId) {
        ...
        loanRepository.submitForUnderwritingNative(loanId);
